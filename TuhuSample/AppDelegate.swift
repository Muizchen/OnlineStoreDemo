...
class AppDelegate: UIResponder, UIApplicationDelegate, BMKGeneralDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if !mapManager!.start("Hkm0Kz4enY15SEjIf98fNX3LjtpqXfEF", generalDelegate: self) {
            NSLog("启动引擎失败")
        }
        
//        let cataloguePage = BMKCataloguePage()
//        let navigationController = UINavigationController.init(rootViewController: cataloguePage)
